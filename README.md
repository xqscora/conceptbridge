...
ConceptBridge is a small educational AI/ML prototype for the SPEED September AI Challenge. It uses a transparent local NLP retrieval model to match an explanation to a concept pattern, surface a boundary case, and ask a discriminating question. The student supplies the explanation and owns the revision.
